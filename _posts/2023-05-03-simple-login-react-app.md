...
В некоторых местах мне пришлось экранировать двойные фигурные скобки, чтобы движок блога нормально отобразил эту строку. Уберити обратный слеш, после вставки в редактор кода, чтобы код заработал.

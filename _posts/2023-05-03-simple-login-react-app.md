...
Обратите внимание на строчку выше. Код `state={% raw %}{{from: location}}{% endraw %} replace` не имеет прямого отношения к авторизации и вы можете пока не обращать на него внимание.

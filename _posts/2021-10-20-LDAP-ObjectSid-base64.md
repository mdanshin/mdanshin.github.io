...
* Вот так выглядит SID пользователя в Active Directory `S-1-5-21-2562418665-3218585558-1813906818-1576`. 
* Вот так выглядит его бинарное представление `010500000000000515000000e967bb98d6b7d7bf82051e6c28060000`. 
* А хранится он в закодированном виде, в формате base64 `AQUAAAAAAAUVAAAA6We7mNa317+CBR5sKAYAAA==`.

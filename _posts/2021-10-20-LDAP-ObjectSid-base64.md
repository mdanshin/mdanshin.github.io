...
# Декодируем его hex-dump-ом и сохраняем в массиве
...
# ${BESA2:6:2} - вывести из массива 2 симовла начиная с шестого. Не забываем, что нумерация идёт с нуля. И заносим их в массив.
...
#На этом этапе у нас в ADDR следующие значения
# ADDR[0] - 000000000005
# ADDR[1] - 00000015
# ADDR[2] - 98BB67E9
# ADDR[3] - BFD7B7D6
...
#$((16#${OBJECT})) - это простое HEX2DEC преборазование - из шестнадцвтеричной формы в десятичную.
